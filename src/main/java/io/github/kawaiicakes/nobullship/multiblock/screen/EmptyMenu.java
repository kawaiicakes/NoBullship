...
import static io.github.kawaiicakes.nobullship.Registry.EMPTY_MENU;

public class EmptyMenu extends AbstractContainerMenu {
    public EmptyMenu(int pContainerId, Inventory inventory, FriendlyByteBuf data) {
        this(pContainerId, inventory);
    }

    public EmptyMenu(int pContainerId, Inventory inventory) {
        super(EMPTY_MENU.get(), pContainerId);
